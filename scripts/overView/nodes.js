 ...
 */
function nodesUpdate (svg, forceLayout, nodes, physics, itemNameOrientation) {
  if (debug) {
...
function nodeMouseOver (overNode) {
  ...
  nodeInfoTipUpdate(nodeText); // Set the tip html and position
}
