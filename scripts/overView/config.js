...
const PROJECT_AS_ROOT = -1;

let width = 1000;         // D3 window Width
let height = 600;         // D3 window height
 ...
 */
function update (graphData, selectedProjectId, rootId = parseInt(PROJECT_AS_ROOT)) {
  if (debug) {
  ...
  edgesUpdate(svg, force, edgesToRender);
  nodesUpdate(svg, force, nodesToRender, true, 1);
